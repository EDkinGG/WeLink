...
public class ShowBlockedUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_blocked_user);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<NewMember, BlockViewHolder> firebaseRecyclerAdapter1 =
                new FirebaseRecyclerAdapter<NewMember, BlockViewHolder>(options1) {
                    @Override
                    protected void onBindViewHolder(@NonNull BlockViewHolder holder, int position, @NonNull NewMember model) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot1 : snapshot.getChildren()){
                    ...
                    Toast.makeText(ShowBlockedUser.this, "Unblocked", Toast.LENGTH_SHORT).show();
                }
